class Nutriments {
  ...
  Nutriments copyWith({
    ...
    return Nutriments(
      ...
      monounsaturatedfat100g:
          monounsaturatedfat100g ?? this.monounsaturatedfat100g,
      polyunsaturatedfat100g:
          polyunsaturatedfat100g ?? this.polyunsaturatedfat100g,
      omega3fat100g: omega3fat100g ?? this.omega3fat100g,
      alphalinolenicacid100g:
          alphalinolenicacid100g ?? this.alphalinolenicacid100g,
      eicosapentaenoicacid100g:
          eicosapentaenoicacid100g ?? this.eicosapentaenoicacid100g,
      docosahexaenoicacid100g:
          docosahexaenoicacid100g ?? this.docosahexaenoicacid100g,
      ...
      gammalinolenicacid100g:
          gammalinolenicacid100g ?? this.gammalinolenicacid100g,
      dihomogammalinolenicacid100g:
          dihomogammalinolenicacid100g ?? this.dihomogammalinolenicacid100g,
      ...
      fruitsvegetablesnuts100g:
          fruitsvegetablesnuts100g ?? this.fruitsvegetablesnuts100g,
    );
  }

  factory Nutriments.fromMap(Map<String, dynamic> map) {
    return Nutriments(
      energy100g: map['energy_100g'].toString(),
      energykj100g: map['energy-kj_100g'].toString(),
      energykcal100g: map['energy-kcal_100g'].toString(),
      proteins100g: map['proteins_100g'].toString(),
      casein100g: map['casein_100g'].toString(),
      serumproteins100g: map['serumproteins_100g'].toString(),
      nucleotides100g: map['nucleotides_100g'].toString(),
      carbohydrates100g: map['carbohydrates_100g'].toString(),
      sugars100g: map['sugars_100g'].toString(),
      sucrose100g: map['sucrose_100g'].toString(),
      glucose100g: map['glucose_100g'].toString(),
      fructose100g: map['fructose_100g'].toString(),
      lactose100g: map['lactose_100g'].toString(),
      maltose100g: map['maltose_100g'].toString(),
      maltodextrins100g: map['maltodextrins_100g'].toString(),
      starch100g: map['starch_100g'].toString(),
      polyols100g: map['polyols_100g'].toString(),
      fat100g: map['fat_100g'].toString(),
      saturatedfat100g: map['saturated-fat_100g'].toString(),
      butyricacid100g: map['butyric-acid_100g'].toString(),
      caproicacid100g: map['caproic-acid_100g'].toString(),
      caprylicacid100g: map['caprylic-acid_100g'].toString(),
      capricacid100g: map['capric-acid_100g'].toString(),
      lauricacid100g: map['lauric-acid_100g'].toString(),
      myristicacid100g: map['myristic-acid_100g'].toString(),
      palmiticacid100g: map['palmitic-acid_100g'].toString(),
      stearicacid100g: map['stearic-acid_100g'].toString(),
      arachidicacid100g: map['arachidic-acid_100g'].toString(),
      behenicacid100g: map['behenic-acid_100g'].toString(),
      lignocericacid100g: map['lignoceric-acid_100g'].toString(),
      ceroticacid100g: map['cerotic-acid_100g'].toString(),
      montanicacid100g: map['montanic-acid_100g'].toString(),
      melissicacid100g: map['melissic-acid_100g'].toString(),
      monounsaturatedfat100g: map['monounsaturated-fat_100g'].toString(),
      polyunsaturatedfat100g: map['polyunsaturated-fat_100g'].toString(),
      omega3fat100g: map['omega3-fat_100g'].toString(),
      alphalinolenicacid100g: map['alphalinolenic-acid_100g'].toString(),
      eicosapentaenoicacid100g: map['eicosapentaenoic-acid_100g'].toString(),
      docosahexaenoicacid100g: map['docosahexaenoic-acid_100g'].toString(),
      omega6fat100g: map['omega6-fat_100g'].toString(),
      linoleicacid100g: map['linoleic-acid_100g'].toString(),
      arachidonicacid100g: map['arachidonic-acid_100g'].toString(),
      gammalinolenicacid100g: map['gammalinolenic-acid_100g'].toString(),
      dihomogammalinolenicacid100g:
          map['dihomogammalinolenic-acid_100g'].toString(),
      omega9fat100g: map['omega9-fat_100g'].toString(),
      oleicacid100g: map['oleic-acid_100g'].toString(),
      elaidicacid100g: map['elaidic-acid_100g'].toString(),
      gondoicacid100g: map['gondoic-acid_100g'].toString(),
      meadacid100g: map['mead-acid_100g'].toString(),
      erucicacid100g: map['erucic-acid_100g'].toString(),
      nervonicacid100g: map['nervonic-acid_100g'].toString(),
      transfat100g: map['trans-fat_100g'].toString(),
      cholesterol100g: map['cholesterol_100g'].toString(),
      fiber100g: map['fiber_100g'].toString(),
      sodium100g: map['sodium_100g'].toString(),
      alcohol100g: map['alcohol_100g'].toString(),
      vitamina100g: map['vitamina_100g'].toString(),
      vitamind100g: map['vitamind_100g'].toString(),
      vitamine100g: map['vitamine_100g'].toString(),
      vitamink100g: map['vitamink_100g'].toString(),
      vitaminc100g: map['vitaminc_100g'].toString(),
      vitaminb1100g: map['vitaminb1_100g'].toString(),
      vitaminb2100g: map['vitaminb2_100g'].toString(),
      vitaminpp100g: map['vitaminpp_100g'].toString(),
      vitaminb6100g: map['vitaminb6_100g'].toString(),
      vitaminb9100g: map['vitaminb9_100g'].toString(),
      vitaminb12100g: map['vitaminb12_100g'].toString(),
      biotin100g: map['biotin_100g'].toString(),
      pantothenicacid100g: map['pantothenic-acid_100g'].toString(),
      silica100g: map['silica_100g'].toString(),
      bicarbonate100g: map['bicarbonate_100g'].toString(),
      potassium100g: map['potassium_100g'].toString(),
      chloride100g: map['chloride_100g'].toString(),
      calcium100g: map['calcium_100g'].toString(),
      phosphorus100g: map['phosphorus_100g'].toString(),
      iron100g: map['iron_100g'].toString(),
      magnesium100g: map['magnesium_100g'].toString(),
      zinc100g: map['zinc_100g'].toString(),
      copper100g: map['copper_100g'].toString(),
      manganese100g: map['manganese_100g'].toString(),
      fluoride100g: map['fluoride_100g'].toString(),
      selenium100g: map['selenium_100g'].toString(),
      chromium100g: map['chromium_100g'].toString(),
      molybdenum100g: map['molybdenum_100g'].toString(),
      iodine100g: map['iodine_100g'].toString(),
      caffeine100g: map['caffeine_100g'].toString(),
      taurine100g: map['taurine_100g'].toString(),
      ph100g: map['ph_100g'].toString(),
      fruitsvegetablesnuts100g: map['fruitsvegetablesnuts_100g'].toString(),
    );
  }

  @override
  String toString() {
    return 'energy: $energy100g kJ, energykcal: $energykcal100g kcal, proteins: $proteins100g g, casein: $casein100g g, serumproteins: $serumproteins100g g, nucleotides: $nucleotides100g g, carbohydrates: $carbohydrates100g g, sugars: $sugars100g g, sucrose: $sucrose100g g, glucose: $glucose100g g, fructose: $fructose100g g, lactose: $lactose100g g, maltose: $maltose100g g, maltodextrins: $maltodextrins100g g, starch: $starch100g g, polyols: $polyols100g g, fat: $fat100g g, saturatedfat: $saturatedfat100g g, butyricacid: $butyricacid100g g, caproicacid: $caproicacid100g g, caprylicacid: $caprylicacid100g g, capricacid: $capricacid100g g, lauricacid: $lauricacid100g g, myristicacid: $myristicacid100g g, palmiticacid: $palmiticacid100g g, stearicacid: $stearicacid100g g, arachidicacid: $arachidicacid100g g, behenicacid: $behenicacid100g g, lignocericacid: $lignocericacid100g g, ceroticacid: $ceroticacid100g g, montanicacid: $montanicacid100g g, melissicacid: $melissicacid100g g, monounsaturatedfat: $monounsaturatedfat100g g, polyunsaturatedfat: $polyunsaturatedfat100g g, omega3fat: $omega3fat100g g, alphalinolenicacid: $alphalinolenicacid100g g, eicosapentaenoicacid: $eicosapentaenoicacid100g g, docosahexaenoicacid: $docosahexaenoicacid100g g, omega6fat: $omega6fat100g g, linoleicacid: $linoleicacid100g g, arachidonicacid: $arachidonicacid100g g, gammalinolenicacid: $gammalinolenicacid100g g, dihomogammalinolenicacid: $dihomogammalinolenicacid100g g, omega9fat: $omega9fat100g g, oleicacid: $oleicacid100g g, elaidicacid: $elaidicacid100g g, gondoicacid: $gondoicacid100g g, meadacid: $meadacid100g g, erucicacid: $erucicacid100g g, nervonicacid: $nervonicacid100g g, transfat: $transfat100g g, cholesterol: $cholesterol100g g, fiber: $fiber100g g, sodium: $sodium100g g, alcohol: $alcohol100g g, vitamina: $vitamina100g g, vitamind: $vitamind100g g, vitamine: $vitamine100g g, vitamink: $vitamink100g g, vitaminc: $vitaminc100g g, vitaminb1: $vitaminb1100g g, vitaminb2: $vitaminb2100g g, vitaminpp: $vitaminpp100g g, vitaminb6: $vitaminb6100g g, vitaminb9: $vitaminb9100g g, vitaminb12: $vitaminb12100g g, biotin: $biotin100g g, pantothenicacid: $pantothenicacid100g g, silica: $silica100g g, bicarbonate: $bicarbonate100g g, potassium: $potassium100g g, chloride: $chloride100g g, calcium: $calcium100g g, phosphorus: $phosphorus100g g, iron: $iron100g g, magnesium: $magnesium100g g, zinc: $zinc100g g, copper: $copper100g g, manganese: $manganese100g g, fluoride: $fluoride100g g, selenium: $selenium100g g, chromium: $chromium100g g, molybdenum: $molybdenum100g g, iodine: $iodine100g g, caffeine: $caffeine100g g, taurine: $taurine100g g, ph: $ph100g g, fruitsvegetablesnuts: $fruitsvegetablesnuts100g';
  }
  ...
  List<List<String>> toList() {
    ...
    List<List<String>> tmpLists = tmpList.map((e) => e.split(':')).toList();
    return tmpLists;
  }
}
